...
public class seviye3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button harf5 = (Button) findViewById(R.id.harf5); harf5.setText(String.valueOf(c[4]));
        ...
        harf5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                clickButon((String) harf5.getText(), harf5);
            }
        });
        ...
        delButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                delete(harf1, harf2, harf3, harf4, harf5);
            }
        });
        ...
        mix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mix(harf1,harf2,harf3,harf4,harf5);
            }
        });
    ...
    public void sendWord(int hedef){
        ...
        final Button harf5 = findViewById(R.id.harf5);
        delete(harf1, harf2, harf3, harf4, harf5);
        kelime="";
    ...
    public void mix(Button harf1,Button harf2, Button harf3, Button harf4, Button harf5){
        if(kelime.equals("")) {
    ...
    public void delete(Button harf1, Button harf2, Button harf3, Button harf4, Button harf5){
