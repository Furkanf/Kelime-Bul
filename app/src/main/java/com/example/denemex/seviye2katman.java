...
public class seviye2katman extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seviye2katman);
        ...
        seviye1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                char[] harfler = {'c' , 'e' , 'a', 'z'};
                nextActivity(v, harfler , 3, "Seviye 2.1");
            }
        });

        seviye2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                char[] harfler = {'ü' , 'm' , 'i' , 't'};
                nextActivity(v, harfler , 3, "Seviye 2.2");
            }
        });


        final char[] randHarfler = new char[5];
        ...
        seviye3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                //char[] harfler = {'ü' , 'a' , 'y' , 'r'};
                nextActivity(v, randHarfler , 4, "Seviye 2.3");
            }
        });

        seviye4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //char[] harfler = {'b' , 'n' , 'i', 'a'};
                nextActivity(v, randHarfler , 5, "Seviye 2.4");
            }
        });
        ...
        seviye5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                char[] harfler = {'a' , 't' , 'k' , 'ı'};
                nextActivity(v, harfler , 5, "Seviye 2.5");
            }
        });

        seviye6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                char[] harfler = {'y' , 'a' , 'p', 'ı'};
                nextActivity(v, harfler , 6, "Seviye 2.6");
            }
        });
    ...
    public void nextActivity(View view, char[] harfler, int hedef, String seviye){
        Intent intent = new Intent(this, seviye2.class);
